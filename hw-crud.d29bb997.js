...
var _getStidentsApiJs = require("./api/get-stidents-api.js");
var _dellsudentsJs = require("./api/dellsudents.js");
var _postSudJs = require("./api/postSud.js");
var _updateStudJs = require("./api/updateStud.js");
...
function renderStudents(arr) {
    tableRef.innerHTML = arr.map(({ id, name, age, course, skills, email, isEnrolled })=>`
      <tr data-id="${id}">
        <td>${id}</td>
        <td>${name}</td>
        <td>${age}</td>
...
getBtn.addEventListener("click", async ()=>{
    const students = await (0, _getStidentsApiJs.getStudentsAPI)();
...
async function addStudent(event) {
    ...
    if (currentEdit) {
        await (0, _updateStudJs.updateStudApi)(currentEdit, studentData);
        currentEdit = null;
    } else await (0, _postSudJs.postStudAPI)(studentData);
    const students = await (0, _getStidentsApiJs.getStudentsAPI)();
    renderStudents(students);
...
tableRef.addEventListener("click", async (event)=>{
    ...
    if (action === "delete") {
        await (0, _dellsudentsJs.delStudAPI)(id);
        const students = await (0, _getStidentsApiJs.getStudentsAPI)();
        renderStudents(students);
    }
    if (action === "edit") {
        ...
        addStudentsForm.elements.isEnrolled.checked = cells[6].textContent === "\u0410\u043A\u0442\u0438\u0432\u043D\u0438\u0439";
    }
});

},{"./api/get-stidents-api.js":"2Ur5c","./api/dellsudents.js":"1U80O","./api/postSud.js":"lqWOl","./api/updateStud.js":"dteit"}],"2Ur5c":[function(require,module,exports,__globalThis) {
...
},{}],"1U80O":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "delStudAPI", ()=>delStudAPI);
const delStudAPI = (id)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lqWOl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postStudAPI", ()=>postStudAPI);
const postStudAPI = (students)=>{
    const options = {
        method: "POST",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dteit":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateStudApi", ()=>updateStudApi);
const updateStudApi = (id, students)=>{
    const options = {
        method: "PUT",
        body: JSON.stringify(students),
        headers: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7SvX3","kyksZ"], "kyksZ", "parcelRequire7a11", {})

//# sourceMappingURL=hw-crud.d29bb997.js.map
